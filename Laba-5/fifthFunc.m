...
% Задание 12
n_image_croped = imcrop(n_image8, [250 1 799 799]);
% Задание 13
...
n_image8 = setObject(n_image8, 'object2.png', 0, 0);
n_image8 = setObject(n_image8, 'object3.png', 720, 720);
n_image8_noise = genImgWithNoise(n_image8, 0.1);
...
n_image_v2 = genImgWithNoise(n_image_v2, 0.1);
...
imgForEdit = imnoise(imgForEdit,'salt & pepper', density);
